...
{userName}: Напиши программу для поиска среднего арифметического двух чисел на языке C#.
Пакос: Вот результат работы Пакоса на языке C#:
...
{{
    ...
    {{
        ...
        var avgSum = (a + b) / 2.0;
        Console.WriteLine(""Среднее арифметическое двух чисел {{0}} и {{1}} = {{2}}"",
            a,
            b,
            avgSum);
    }}
